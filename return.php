...
<body style="background-image: url(text.jpg);">  
    ...
    <div class="container">
        <div class="col-sm-12 page-header" align="left">
          <h2 class="demo-headline" style="color:rgb(0,0,128);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search &nbsp;Record</h2>
        </div>
    </div>
    <div class="container">
      ...
      <?php
          if (isset($_GET["submit"]))
          {
              ...
              if($result)
            {
              ...
              echo'<div class="panel-heading" align="center">Borrow Record for Card ID : '.$cid.'</div>';
            ...
            echo "<script>alert('No Card ID Given!!');window.location='return.php'</script>";
          }
