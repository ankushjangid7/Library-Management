<html lang="en">
  ...
  <body style="background-image: url(text.jpg);">  
    ...
    <div class="container">
      <form method="get" action="searchregular.php">
      ...
      <?php
          if (isset($_GET["submit"]))
          {
            ...
            if($arr)
            {
              ...
              echo '<tr>';
              echo  "<td width='5%' align='left' >ID</th>";
              echo  "<td width='20%' align='left' >Name</th>";
              echo  "<td width='5%' align='left' >Category</th>";
              echo  "<td width='20%' align='left' >Publisher</th>";
              echo  "<td width='20%' align='left' >Author</th>";
              echo  "<td width='5%' align='left' >Year</th>";
			        echo  "<td width='5%' align='left' >Total</th>";
              echo  "<td width='5%' align='left' >Stock</th>";
              echo  "<td width='5%' align='left' >Rack</th>";
              echo '</tr>';
